...
export default function ProfileScreen() {
    ...
    const menuItems = [
        ...
        { icon: 'heart-outline', label: `My Favorites (${favoritesCount})`, color: '#FF6B6B' },
    ...
    return (
            <ScrollView className="flex-1 bg-gray-50">
                <View className="bg-white pt-16 pb-6 px-6 items-center border-b border-gray-100">
                    ...
                    <Text className="text-2xl font-bold text-gray-800 mb-1">Ngô Minh Tân</Text>
                ...
                <View className="bg-white mx-4 mt-4 rounded-xl p-4 flex-row justify-around shadow-sm">
                    <View className="items-center">
                        <Text className="text-2xl font-bold text-gray-800">{favoritesCount}</Text>
